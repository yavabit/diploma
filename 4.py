...
def calculate_pitch_angles(true_heights, terrain_heights, lookahead=1, window_size=5, max_pitch_angle=20):
    height_diffs = terrain_heights[lookahead:] - terrain_heights[:-lookahead]
    horizontal_diffs = true_heights[lookahead:] - true_heights[:-lookahead]
